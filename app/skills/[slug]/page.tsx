...
export async function generateMetadata({params}:{params:Promise<{slug:string}>}):Promise<Metadata>{
  try{
    ...
    if(skill)return {title:`${skill.title} · PWS STUDIO`,description:skill.summary,openGraph:{title:skill.title,description:skill.summary,images:[]},twitter:{card:'summary',title:skill.title,description:skill.summary,images:[]}};
  }catch{}
